...
function is_exact($value1, $value2)/*isrpavan nacin
poredenja, umjesto is_equal kao gore, koristiti funkciju
is_exact i trostruki znak jednakosti, kao ovdje na liniji
47 prilikom poredenja vrijednosti,ista funkcija se poziva
naravno pri prikazu - od linija 57-70*/
{
    $output="{$value1} === {$value2}: ";
    if ($value1 === $value2) {
        $output.="true<br />";
